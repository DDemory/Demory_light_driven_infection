function [params,paramsname,paravec] = setup_para(i,LHsample,xl,xu,Hypo,iniH,aveH,stdH,iniV,aveV,stdV)
...
params = {
    ...
    {'Lysis',       LH(3), xl(3), xu(3), LH(3), Inf, 1,       0}
    {'Burst',       LH(5), xl(5), xu(5), LH(5), Inf, 1,       0}
    {'S0',          iniH,  0,     Inf,   aveH,stdH,0,       1}
    {'V0',          iniV,  0,     Inf,   aveV,stdV,0,       1}
    };

paramsname = {'Adsorption','Lysis', 'Burst'};
paravec = [LH(1) LH(3) LH(5)];
...
paravec = [LH(1) LH(2) LH(3) LH(5) LH(6)];
...
paravec = [LH(1) LH(3) LH(4) LH(5) LH(6)];
